from run_with_params import train_with_params
from run_with_params import select_dims
...
# # # Refinement model for Figure 6(a). Trains an auxiliary refining encoder 
# # # and decoder on top of the universal encoder
...
Lambda_bases = [0, 0.00025, 0.0005, 0.001, 0.0015]
